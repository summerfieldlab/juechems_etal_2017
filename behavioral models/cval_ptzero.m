...
function [params,fit] = cval_ptzero(data,use,sub,flag,init_params,bnd_low,bnd_up,crossval,n_Iter)

% DEFAULT: n_Iter = 20; For flag = 'anneal', and
%          n_Iter = 100; for flag = 'fmin';
